...
<body>
	<div class="sidebar">
		...
		<ul class="nav-links">
			...
			<li><a href="s_details.jsp"> <i class='bx bx-box'></i> <span
	...
	<section class="home-section">
		...
		<div class="home-content">
			<div class="overview-boxes">
				...
				<div class="box">
					<div class="right-side">
						<div class="box-topic">Total Alumnis</div>
				...
				<div class="box">
					<div class="right-side">
						<div class="box-topic">Total Traffic</div>
						<div class="number">7,086</div>
						<div class="indicator"></div>
					</div>
					<i class='bx bx-traffic-cone cart four'></i>
				</div>
			</div>

			<div class="sales-boxes">
				<div class="recent-sales box">
					<div class="title">Recent Alumnis</div>
